        ...
        <div class="p-3 ml-3" style="width: 90%">
            <div
                ...
                <div class="col-auto align-items-center">
                    <img src="{{Storage::url('apartments/'.$apartment->image_2)}}" width="225" height="190" alt="Hotel photo"
                         class="mb-4"/><br>
                    <img src="{{Storage::url('apartments/'.$apartment->image_3)}}" width="225" height="190" alt="Hotel photo"/>
                </div>
            </div>
        </div>
    </main>
